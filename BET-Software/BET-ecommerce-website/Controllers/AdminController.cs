    ...
    public class AdminController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                HttpResponseMessage Response = await client.GetAsync("Product/products");
        ...
        public ActionResult Add(ProductViewModel product)
        {
            using (var client = new HttpClient())
            {
                ...
                //byte[] uploadedFile = new byte[product.Image.InputStream.Length];

                // product.Image.InputStream.Read(uploadedFile, 0, uploadedFile.Length);

                //product.FileContent = uploadedFile;

                //ByteArrayContent byteContent = new ByteArrayContent(product.FileContent);
